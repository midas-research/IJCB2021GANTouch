...
scaler = unpickling("scaler_GAN_Phone_selectK_umdaa.pkl")
transformer = unpickling("transformer_GAN_Phone_selectK_umdaa.pkl")
gender_list = parse_demographics()

file_ptr = open("GAN_Attack_SVM_hmog_umdaa.out", "w")
...
for model in models:
    ...
    final_hter_f = []
    for i in range(1,37):
        # Replace random_attack_data.pkl with attack data.
        acc, far, frr, hter = attack3("random_attack_data.pkl",str(model)+"_"+str(i)+"GAN_Phone_GAN_umdaa.pkl")
