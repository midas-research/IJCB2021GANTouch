...
scaler = unpickling("scaler_GAN_Phone_selectK.pkl")
transformer = unpickling("transformer_GAN_Phone_selectK.pkl")
gender_list = parse_demographics()

file_ptr = open("GAN_Attack_POP.out", "w")
...
for model in models:
    ...
    for i in range(1,117):
        # Replace pop_data_10000.pkl with attack data.
        acc, far, frr, hter = attack("pop_data_10000.pkl",str(model)+"_"+str(i)+"GAN_Phone_GAN.pkl")
